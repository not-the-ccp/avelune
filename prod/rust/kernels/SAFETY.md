...
compare all locally available backends against scalar, including edge/non-vector lengths; inverse-WHT
coverage currently includes 20,000 randomized coefficient blocks in addition to end-to-end codec
differential tests.
