...
The canonical Rust decoder and the independent scalar decoder in `avelune-reference` are informative implementations. Neither source tree is normative. Differential tests check canonical-encoder ALV1 output through both reconstruction implementations.
