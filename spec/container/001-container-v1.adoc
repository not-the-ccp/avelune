...
The Baseline media payloads are defined by xref:../video/001-video-v1.adoc#alv1-frame-packet[ALV1 video] and xref:../audio/001-audio-v1.adoc#ala1-packet[ALA1 audio].
...
Kinds: 1 EpochStart, 2 VideoFrame, 3 AudioFrame, 4 Metadata. A V1 decoder MUST bound packet allocation before reading payload; the canonical implementation default maximum is 128 MiB.
