...
def artifact(size=1000,psnr=40.0,ssim=.99,t=.1):
    return {'schema':'avelune-ci-media-v2','cases':[{'case':'x','source_sha256':'same','encoded_bytes':size,'psnr_db':psnr,'ssim':ssim,'encode_seconds_median':t,'decode_seconds_median':t}]}
